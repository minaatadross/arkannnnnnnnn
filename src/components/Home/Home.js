...
const Home = () => {
  ...
  return (
    <main className="home-page">
        ...
        <div className="hero__content container reveal">
          ...
          <div className="hero__cta">
            ...
            <button
              ...
              onClick={() => {
                document
                  .querySelector(".exhibition-projects")
          ...
          {/* stats section should be reveal so observer triggers it */}
      ...
      {/* Services Overview Section (OUR EXPERTISE) */}
      <section className="services-overview section">
        <div className="container">
          {/* IMPORTANT: make it reveal (NOT reveal in), observer will add in */}
          ...
          <div className="services-grid">
            ...
            <div className="service-card animate-on-scroll delay-1">
              ...
              <div className="service-card__content">
                ...
                <p>{t("home.services.production.description")}</p>
                <div className="service-card__features">
        ...
        <div className="container">
          <div className="about-content reveal">
            <div className="about-content__text">
              <span className="section__subtitle">
                {t("home.aboutPreview.subtitle")}
              </span>
              <h2 className="section__title">{t("home.aboutPreview.title")}</h2>
              <p className="about-text">{t("home.aboutPreview.description")}</p>
              ...
              <div className="about-highlights">
                <div className="highlight-item">
                  ...
                  <p>
                    {t(
                      "home.aboutPreview.highlights.leadership.description"
                    )}
                  </p>
                </div>
                <div className="highlight-item">
                  ...
                  <p>
                    {t(
                      "home.aboutPreview.highlights.partnership.description"
                    )}
                  </p>
                </div>
              </div>
      ...
      <section className="exhibition-projects section">
        <div className="container">
          <Gallery images={exhibitionProjects} title={t("home.portfolio.title")} />
